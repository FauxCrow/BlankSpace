...
@export var happiness: int	# player decides -- should this be string or int or just a simple "is it happy?" where every answer is no LOL

# Make sure that every parameter has a default value.
# Otherwise, there will be problems with creating and editing
# your resource via the inspector.
func _init(p_image = null, p_planetCode = "", p_name = "", p_planetName = "", p_habitat = "", p_diet = "", p_happiness = 0):
	image = p_image
